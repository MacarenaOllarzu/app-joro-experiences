...
// cargar estado follow + mi username
useEffect(() => {
async function init() {
...
// 2. Insertar follow y obtener ID
...
const followRelationshipId = followData[0].id; // El ID de la relación

setIsFollowing(true);

// 3. Notificación al seguido, usando el ID de la relación
await supabase.from("activity_feed").insert({
user_id: user.id,
actor_id: currentUserId,
activity_type: "new_follower",

// Campos requeridos NOT NULL (usamos los IDs de usuario como valores válidos)
objective_id: user.id, 
objective_item_id: currentUserId,

// Clave para la eliminación en cascada
...
// 1. Borrar follow. La DB se encarga del resto (ON DELETE CASCADE)
...
// ✅ Eliminamos el código de borrado manual de activity_feed,
// ¡ya no es necesario!
